...
class AppUtilsComponent extends Component {
	...
	*/
	...
	/**
	* Método zip
	* Compacta todos os arquivos passados pelo parametro
	*
	* @param array $files| Arquivos a serem compactados
	* @param string $destination| Destino onde sera salvo o zip
	* @return bool $overwrite| Sobrescrever o arquivo existente
	*/
	public function zip($files=array(), $destination='', $overwrite=false) {
