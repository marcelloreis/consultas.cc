	...
	<ul class="tiles" style="margin:25px 0 0 25px;">
		...
		<?php else:?>
			<li class="blue">
				...
				<?php echo $this->Html->link('<span><i class="glyphicon-database_plus"></i></span><span class="name">Adicionar</span>', array('action' => 'add', 'client_id' => $client_id, 'plugin' => false), array('escape' => false))?>
			</li>
			<li class="red">
				<?php echo $this->Html->link('<span><i class="glyphicon-list"></i></span><span class="name">Listar todos</span>', array('action' => 'accounts', 'plugin' => false), array('escape' => false))?>
			</li>
			<li class="grey">
				<?php echo $this->Html->link('<span><i class="icon-trash"></i></span><span class="name">Lixeira</span>', array('action' => 'accounts', ACTION_TRASH => true, 'plugin' => false), array('escape' => false))?>
			</li>
		<?php endif?>
	</ul>
</div>
