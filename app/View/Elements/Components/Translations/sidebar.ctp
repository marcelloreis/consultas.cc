<div id="left">
	<ul class="tiles" style="margin:25px 0 0 25px;">
		...
		<li class="green">
			<?php echo $this->Html->link('<span><i class="icon-font"></i></span><span class="name">Traduzir</span>', array('controller' => 'translations', 'action' => 'loadLocale', 'plugin' => false), array('escape' => false))?>
		</li>
	</ul>
</div>