...
echo $this->Html->link('<i class="icon-copy"></i>', array("controller" => $this->params['controller'], "action" => "generate", $id), array('title' => 'Gerar Contrato', 'class' => 'btn', 'rel' => 'tooltip', 'data-original-title' => 'Gerar Contrato', 'escape' => false)) . ' ';
?>