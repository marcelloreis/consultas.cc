...
echo $this->Html->link('<i class="icon-unlock"></i>', array("controller" => 'acl', "action" => "permissions", 'aro_id' => $id, 'aro' => 'group', 'plugin' => 'main'), array('title' => __('Permissions'), 'class' => 'btn', 'rel' => 'tooltip', 'data-original-title' => __('Permissions'), 'escape' => false)) . '&nbsp;';