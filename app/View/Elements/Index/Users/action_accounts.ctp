<?php 
echo $this->Html->link('<i class="icon-search"></i>', array("controller" => $this->params['controller'], "action" => "view", $id, 'client_id' => $client_id), array('title' => __('View Record'), 'class' => 'btn', 'rel' => 'tooltip', 'data-original-title' => __('View Record'), 'escape' => false)) . '&nbsp;';
echo $this->Html->link('<i class="icon-edit"></i>', array("controller" => $this->params['controller'], "action" => "edit", $id, 'client_id' => $client_id), array('title' => __('Edit Record'), 'class' => 'btn', 'rel' => 'tooltip', 'data-original-title' => __('Edit Record'), 'escape' => false)) . '&nbsp;';
