...
echo $this->Html->link('<i class="icon-unlock"></i>', array("controller" => 'acl', "action" => "permissions", 'aro_id' => $id, 'aro' => 'user', 'plugin' => 'main'), array('title' => 'Permissões', 'class' => 'btn', 'rel' => 'tooltip', 'data-original-title' => 'Permissões', 'escape' => false)) . '&nbsp;';