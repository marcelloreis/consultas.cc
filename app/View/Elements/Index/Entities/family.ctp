<div class="row-fluid">
    <div class="span12">
        <div class="box box-bordered box-color">
            <div class="box-title">
                <h3><i class="glyphicon-parents"></i> <?php echo __d('app', 'Family')?></h3>
            </div>
            <div class="box-content">
                <!-- Empresa 1 -->
                <blockquote>
                    <h4>
                        <?php echo $this->Html->link(__d('app', 'Sister'), '#', array('class' => 'btn btn-info'))?>
                        <?php echo $this->Html->link('Elizabeth Martins dos Reis', array('controller' => '', 'action' => ''))?>
                    </h4>
