<h4><i class="icon-phone"></i> <?php echo __('Search by landline')?></h4>
    ...
    <?php echo $this->AppForm->create($modelClass, array('url' => '/entities/landline', 'defaultSize' => 'input-xlarge', 'classForm' => 'form-horizontal form-bordered'))?>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                ...
                <?php echo $this->AppForm->input('tel', array('template' => 'form-input-clean', 'class' => 'input-block-level msk-phone', 'value' => $landline, 'placeholder' => __('type landline')))?>
            </div>
        </div>
