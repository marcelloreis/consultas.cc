...
if(empty($contract_id)){
	echo $this->Html->link('<i class="icon-file-alt"></i>', array("controller" => $this->params['controller'], "action" => "contract"), array('title' => __('Generate Contract'), 'class' => 'btn', 'rel' => 'tooltip', 'data-original-title' => __('Generate Contract'), 'escape' => false)) . ' ';
}else{
	echo $this->Html->link('<i class="icon-copy"></i>', array("controller" => $this->params['controller'], "action" => "contract", $id), array('title' => __('Generate Contract'), 'class' => 'btn', 'rel' => 'tooltip', 'data-original-title' => __('Generate Contract'), 'escape' => false)) . ' ';
}
?>