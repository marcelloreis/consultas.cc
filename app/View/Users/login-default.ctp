                    ...
                    <div id="login-content-inner">
                        ...
                        <div id="etab2" class="etabs-content">
                            <?php echo $this->AppForm->create('User') ?>
                                ...
                                ?>
                                <?php echo $this->AppForm->input('email', array('value' => $loginHomolog, 'template' => 'form-input-login', 'class' => 'email', 'placeholder' => 'E-mail', 'tabindex' => "1", 'data-validation-type' => "email")) ?>
                                <div class="spacer-10"><!-- spacer 20px --></div> 
                                <?php echo $this->AppForm->input('password', array('value' => $passHomolog, 'template' => 'form-input-login', 'class' => 'password', 'placeholder' => 'Senha', 'tabindex' => "2", 'data-validation-type' => "present")) ?>
                                <div class="spacer-10"><!-- spacer 20px --></div> 
