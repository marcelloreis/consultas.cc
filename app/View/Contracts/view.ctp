...
echo $this->element('Components/Contracts/title-view');
$this->end();
			...
			<div class="span10">
				<blockquote style="text-align:justify;" class="pull-right">
					<p style="text-align:justify;">
						...
						<?php echo !empty($contract['Client']['City']['name'])?$contract['Client']['City']['name']:'';?>/<?php echo $contract['Client']['State']['uf']?> - CEP: <?php echo $this->AppUtils->zipcode($contract['Client']['zipcode'])?>, 
