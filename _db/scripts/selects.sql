...
SELECT * FROM naszaco_pessoas.entities;
SELECT * FROM naszaco_pessoas.associations;
SELECT * FROM naszaco_pessoas.addresses;
SELECT * FROM naszaco_pessoas.zipcodes order by id desc;
SELECT * FROM naszaco_pessoas.landlines;
